...
_C.model.deformation_graph.num_anchors = 8
_C.model.deformation_graph.node_coverage = 0.08 #0.08
...
# ====================== GESM-PC (Neural) ======================
_C.model.gesm = edict()
_C.model.gesm.enabled = True
_C.model.gesm.lambda_gesm = 2.0 #0.0001          # 建议范围：5e2 ~ 5e3
_C.model.gesm.lambda_corr = 25.0
_C.model.gesm.method = 'householder'
_C.model.gesm.num_epochs_test = 300
_C.model.gesm.use_normal = True
_C.model.gesm.lr_test = 1e-4
_C.model.gesm.jacb_reg = 1.0
